...
local Translations = {
    info = {
        ...
        ['repair_brakes'] = "Remleiding van voertuigen repareren",
        ...
        ['brakes_are_working_fine'] = "De remmen van het voertuig werken al prima...",
        ['brakes_are_already_broken'] = "The vehicle's brakes are already broken...",
        ['need_a_item'] = "Je hebt een %{item} nodig.",
        ...
        ['brakeslines_fixed'] = "De remleidingen zijn gerepareerd",
        ['wrong_job'] = 'Je bent niet opgeleid als (%{job}) om dit te kunnen doen.',
        ['brake_lines_are_broken'] = "Je kunt de remolie niet bijvullen omdat uw leidingen kapot zijn...",
